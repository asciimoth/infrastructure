...
globalkeys = gears.table.join(
    ...
    -- Print screen
    awful.key({}, "Print", function() awful.util.spawn("copyscreen") end,
...
client.connect_signal("manage", function (c)
  ...
  if c.floating and not c.requests_no_titlebar and not c.title == "Picture-in-Picture" then
  ...
  -- if c.title == "Picture-in-Picture" then
  --  c.ontop = true
  --  c.floating = true
  --  c.sticky = true
  --  -- position
...
client.connect_signal("property::floating", function(c)
  ...
  -- if c.floating and c.title == "Picture-in-Picture" then
  --  c.ontop = true
  --else
  --  c.ontop = false
  --end
...
-- naughty.notify({ preset = naughty.config.presets.critical,
--   title = "A",
--   text = gears.filesystem.get_themes_dir() })
